      ...
      <div className="shadow-2xl">
        <div className="flex items-center p-4 m-auto bg-white border border-memyo-yellow8 rounded-xl md:w-[350px] md:h-2/4 md:space-y-3 justify-between md:w-[674px] md:h-[309px] md:p-16">
          <div className="flex space-x-4 ">
            <div className="flex md:flex-col md:justify-center md:items-center md:text-center">
              <img
                className="object-cover w-20 h-20 mr-4 rounded-full md:mr-0 md:w-40 md:h-40 md:rounded-full"
              ...
              <div className="flex items-center md:h-24">
                <div className="space-y-1 ">
                  <p className="font-semibold text-md ">Woody</p>
                  <p className="text-xs text-gray-700">27세</p>
          ...
          <img className="md:w-14" src={adoptionHeart} alt="adoptionheart" />
          <div>
            <img
            ...
            <div className="hidden md:block md:flex md:flex-col md:justify-center md:items-center md:space-y-1 md:h-24">
              <p className="font-semibold text-md ">신디</p>
              <p className="text-xs text-gray-700">1세</p>
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="6 0 28 25"
