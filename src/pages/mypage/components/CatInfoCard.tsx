...
function CatInfoCard({ noticeInfo }: CatInfoCardProps) {
  return (
    <section>
      <div className="border border-memyo-yellow8 rounded-2xl md:w-[348px] md:h-[427px] md:space-y-2">
        <div
          ...
          style={{
            backgroundImage: `url(${noticeInfo.thumbnail})`,
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-1 md:relative">
                    <div className="flex flex-col">
                      ...
                      <p className="text-xs font-bold">이름: {noticeInfo.catName}</p>
                    </div>
                  </div>
                  <div className="md:block md:flex md:space-x-2">
                    <p className="text-xs">묘종: {noticeInfo.catSpecies}</p>
                  </div>
                  <div className="flex flex-col">
                    <div className="flex">
                      <svg
                      ...
                      <p className="text-xs ">{noticeInfo.shelterCity}</p>
                    </div>
                    <div className="flex items-center">
                      <BiCommentDetail className="w-3 h-3 mr-1 text-memyo-yellow8" />
                      <p className="text-xs">댓글: {noticeInfo.commentCount}</p>
                    </div>
                  </div>
                </div>
              </div>
