  ...
  return (
    <div className=" md:flex md:justify-center md:items-center">
      <div className="border-2 border-gray-200 rounded-2xl md:w-60 md:h-96">
        <div className="flex items-center justify-center bg-white rounded-2xl md:flex-col">
          <div>
            <img
          ...
          <div className="flex items-center space-x-10">
            ...
            <img className="w-16 h-16 opacity-70 md:hidden" src={approvedImg} alt="stampImage" />
          </div>
        </div>
      </div>
    </div>
