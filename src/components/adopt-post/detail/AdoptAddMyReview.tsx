    ...
    <div className="border-b h-48">
      ...
      <div className="w-full p-2 flex justify-between">
        <div className="flex items-center w-24 h-16">
          <img
            src="https://storage.googleapis.com/myohanmeeting/profile/e450b369-5a55-4efc-be51-41f7e2a0be57-1692020811373.jpg"
      ...
      <div className="float-right">
        <button
          className=" bg-memyo-yellow6 p-2 w-20 text-sm text-white rounded-md flex justify-center items-center"
