...
function AdoptWebTemplate() {
  ...
  return (
    <div className="flex flex-col">
      <section className="flex flex-col justify-center w-full h-full p-2 my-4 mt-6">
        <div className="flex justify-center">
          <p className="flex justify-center w-20 p-1 text-sm bg-gray-100 font-pretendard">
            공고 등록
          </p>
        </div>
        ...
        <div className="w-full text-right">
          <button
            type="submit"
            className="text-white bg-memyo-yellow4 hover:bg-memyo-yellow6 focus:ring-4 focus:outline-none w-full focus:ring-blue-300 font-medium rounded-lg text-sm  md:w-1/3 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            onClick={handlePost}
          >
            Submit
          </button>
